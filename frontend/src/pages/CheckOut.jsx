...
function CheckOut() {
  ...
  const getLatLngByAddress = async () => {
    try {
      ...
      console.log(error);
      alert("Address physically not found, drop the pin manually to select your house.");
    }
  };
  ...
  try {
    ...
    if (!address || !location?.lat || !location?.lon) {
      alert("Please search your address or move the map pin.");
      return;
    }
    ...
    const result = await axios.post(
      ...
      {
        // ✅ FIX 1: payment method already correct (cod/online)
        paymentMethod,

        // ✅ FIX 2: correct address
        deliveryAddress: {
          text: address,
        ...
        // ✅ FIX 3: ONLY items total (NO delivery fee)
